...
import DataProvider.util.ForDataProvider;
...
public class AddCustomer2 {
    ...
    Object[][] getData() throws IOException {
        ...
        /*Object[][] data = getMyData("data/myData2.xlsx", "addCustomer");

        return data;*/

      /*  ForDataProvider ob = new ForDataProvider();

        return ob.getMyData("data/myData2.xlsx", "addCustomer");*/



        return getMyData("data/myData2.xlsx", "addCustomer");
    }
}
